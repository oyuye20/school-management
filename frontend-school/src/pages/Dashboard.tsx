                    ...
                    <div className="flex p-4 gap-3">
                        ...
                        <div className="left-main grow">
                            ...
                            <div className="div flex gap-4 text-[#3B3B3B]">
                                ...
                                <div className="cards grow p-4 rounded-lg flex
                        ...
                        <div className="right-main min-w-[300px] overflow-auto">
                            <div className="bg-[#f2fef0] rounded-lg p-1 py-4">
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    ...
                                    <h1 className="text-center font-semibold text-xl text-[#3B3B3B]">Events</h1>
                                </div>
                                ...
                                <div className="card p-2 flex gap-5">
                                    <div className="shadow-md flex flex-col gap-4 p-4">
                                        <h1 className="font-semibold text-[#3B3B3B] text-center ">Holiday</h1>

                                        <div className="w-[300px] overflow-scroll h-[200px]">
                                            <p >Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                Placeat ex quaerat, obcaecati amet ipsum sequi atque voluptate
                                                recusandae odit, quas officiis. Corporis, iste alias. Culpa ad a modi ex sapiente!
                                                ecati amet ipsum sequi atque voluptate
                                                recusandae odit, quas officiis. Corporis, iste alias. Culpa ad a modi ex sapiente!
                                                ecati amet ipsum sequi atque voluptate
                                                recusandae odit, quas officiis. Corporis, iste alias. Culpa ad a modi ex sapiente!
                                                ecati amet ipsum sequi atque voluptate
