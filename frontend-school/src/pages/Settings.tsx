                    ...
                    <div className="p-4">
                        ...
                        <div className="profileInfo flex flex-col items-center gap-5 px-11 py-10 shadow-lg rounded-lg">
                            ...
                            <div className="form-group w-full flex flex-col gap-2">
                                ...
                                <input type="text" className="input focus:outline-0 w-full" value={`Jane Doe`} readOnly />
                            </div>

                            <div className="form-group w-full flex flex-col gap-2">
                                <label htmlFor="">Email</label>
                                <input type="text" className="input focus:outline-0 w-full" value={`haha@gmail.com`} readOnly />
                            </div>

                            <div className="form-group w-full flex flex-col gap-2">
                                <label htmlFor="">Grade</label>
                                <input type="text" className="input focus:outline-0 w-full" value={`11`} readOnly />
                            </div>

                            <div className="form-group w-full flex flex-col gap-2">
                                <label htmlFor="">Section</label>
                                <input type="text" className="input focus:outline-0 w-full" value={`Earth`} readOnly />
                            </div>
